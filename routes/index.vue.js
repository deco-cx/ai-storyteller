                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="bg-[#E0F2FE] border border-[#BAE6FD] rounded-xl p-8">
                            <h3 class="text-2xl font-semibold text-[#00B7EA] mb-6">Pablo the Knight and the Desert Oasis</h3>
                            ...
                            <div class="space-y-6 mb-12">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-full p-2 text-lg text-gray-600 flex items-center gap-2">
                                        <img src="https://github.com/user-attachments/assets/754281d3-a02b-41de-a9ef-ead820c40729" class="w-8 h-8 rounded-full" />
                    ...
                    <div class="space-y-6">
                        <div class="bg-[#E0F2FE] border border-[#BAE6FD] rounded-xl p-8">
                            <h3 class="text-2xl font-semibold text-[#00B7EA] mb-6">The Magic Garden Adventure</h3>
                    ...
                    <div class="space-y-6">
                        <div class="bg-[#E0F2FE] border border-[#BAE6FD] rounded-xl p-8">
                            <h3 class="text-2xl font-semibold text-[#00B7EA] mb-6">The Space Explorer's Journey</h3>
